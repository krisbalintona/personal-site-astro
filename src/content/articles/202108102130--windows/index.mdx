...
<Heading level="2" id="beauty"selfLink={true}>Beauty</Heading>
...
<Heading level="2" id="discomfort"selfLink={true}>Discomfort</Heading>
...
<Heading level="2" id="inquiry"selfLink={true}>Inquiry</Heading>
...
<Heading level="2" id="without"selfLink={true}>Without</Heading>
...
<Heading level="2" id="comfort"selfLink={true}>Comfort</Heading>
...
<Heading level="2" id="unnoticed"selfLink={true}>Unnoticed</Heading>
