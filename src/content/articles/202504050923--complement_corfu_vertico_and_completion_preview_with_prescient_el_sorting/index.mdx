...
pubDate: 2025-04-05T09:23:00-05:00
draft: false
tags:
  - "Emacs"
---
...
<Alert><Timestamp date="2025-04-07" /> With several commits made on April 6, 2025, vertico spun off its sorting functionality into an extension: [vertico-sort](https://github.com/minad/vertico/blob/main/extensions/vertico-sort.el). As explained in vertico-sort.el's commentary section, it includes a new feature: when `history-delete-duplicates` is nil, all sorting functions defined in vertico-sort.el now rank *recently* selected candidates above frequently selected candidates. This approximates the sorting strategy of prescient.el. I think I'll stick with prescient.el sorting because I like `history-delete-duplicates` set to non-nil, but try it out yourself!</Alert>

<Alert><Timestamp date="2025-04-22" /> Corfu now offers a similar functionality as vertic-sort does for vertico with the new [corfu-sort](https://github.com/minad/corfu/blob/main/extensions/corfu-history.el) extension. Like vertico-sort, corfu-sort requires `history-delete-duplicates` to be nil.</Alert>

[Prescient.el](https://github.com/radian-software/prescient.el) is a package that was popular during the era of ivy and helm. Nowadays, I don't see it mentioned much because of the very popular corfu + vertico + marginalia + orderless combination which enhance built-in Emacs completion and overtaken ivy and helm in terms of popularity. (And it's deserved! I use this combination, too.)<FootnoteRef num="1" /> But I've found prescient.el a noticeable convenience that complements this set of packages.
...
<h2 id="bonus-integration-with-completion-preview-mode"><a class="heading-self-link" href="#bonus-integration-with-completion-preview-mode">Bonus: integration with `completion-preview-mode`</a></h2>
...
-   <Timestamp date="2025-04-22" />
    -   Added a note mentioning the new corfu-history extension.

<FootnoteSection>
Footnotes
<Footnote num="1" slot="footnotes">
In my opinion, each package is much more modular than the helm or ivy ecosystems while being more performant, integrated with existing Emacs functionality, and just as useful, if not more. Though a bit dated, I've previously written a big about how to configure this set of packages: <ContentLink collectionName="articles" id="202202211546--vertico_marginalia_all_the_icons_completion_and_orderless">Vertico, Marginalia, All-the-icons-completion, and Orderless</ContentLink>.
</Footnote>
</FootnoteSection>
