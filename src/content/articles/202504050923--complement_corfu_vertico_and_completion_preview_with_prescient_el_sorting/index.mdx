...
lastMod: 2025-04-22T04:42:00-05:00
tags:
  - "Emacs"
  - "Tips and Tricks"
threads:
...
<Alert>
<Timestamp date="2025-04-22" /> Corfu now offers a similar functionality as vertic-sort does for vertico with the new [corfu-sort](https://github.com/minad/corfu/blob/main/extensions/corfu-history.el) extension. Like vertico-sort, corfu-sort requires `history-delete-duplicates` to be nil.
</Alert>
