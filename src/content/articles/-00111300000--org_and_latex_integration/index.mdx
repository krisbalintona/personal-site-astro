...
<h2 id="my-desired-workflow"><a href="#my-desired-workflow">My desired workflow</a></h2>
...
<h2 id="basic-formatting-org-latex-classes"><a href="#basic-formatting-org-latex-classes">Basic Formatting: `org-latex-classes`</a></h2>

<h2 id="title-pages-creating-an-org-export-backend"><a href="#title-pages-creating-an-org-export-backend">Title pages: Creating an Org-export backend</a></h2>

The most challenging hurdle is conveniently producing a formatted title page<FootnoteRef name="1" />.
...
<h3 id="customize-the-org-export-latex-backend"><a href="#customize-the-org-export-latex-backend">Customize the `org-export` LaTeX backend</a></h3>

File properties

<h4 id="backend"><a href="#backend">Backend</a></h4>
...
<h4 id="template"><a href="#template">Template</a></h4>

<h3 id="final-title-command"><a href="#final-title-command">Final title command</a></h3>
...
<h2 id="citations-and-bibliographies-org-cite"><a href="#citations-and-bibliographies-org-cite">Citations and bibliographies: Org-cite</a></h2>
...
<h3 id="one-way-to-specify-citation-style"><a href="#one-way-to-specify-citation-style">One way to specify citation style</a></h3>
...
<h3 id="my-method-to-specify-citation-style"><a href="#my-method-to-specify-citation-style">My method to specify citation style</a></h3>
...
<h2 id="final-result-and-screenshots"><a href="#final-result-and-screenshots">Final result and screenshots</a></h2>

The following org file produces this:

which, compiled into a PDF, looks like this:

<h2 id="extras"><a href="#extras">Extras</a></h2>

<div class="outline-text-2" id="text-extras">
</div>
<h3 id="section-numbers"><a href="#section-numbers">Section numbers</a></h3>

```elisp
(setq org-export-with-section-numbers nil)
```

<h3 id="hyperref"><a href="#hyperref">Hyperref</a></h3>
...
<h3 id="org-links"><a href="#org-links">Org links</a></h3>

1.  Custom `org-mode` links (`org-link-set-parameters`)

<h2 id="full-configuration"><a href="#full-configuration">Full configuration</a></h2>
