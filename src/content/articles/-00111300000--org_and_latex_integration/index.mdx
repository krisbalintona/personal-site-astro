...
The most challenging hurdle is conveniently producing a formatted title page<sup><a id="fnref-1" class="fnref" href="#fn-1" role="doc-backlink" aria-label="Footnote 1">1</a></sup>.
...
<sup><a id="fn-1" href="#fnref-1">1</a></sup> I use the term “title page” to reference what a stylesheet specifies as the format of a title, even if it does not create an entirely new page, e.g., MLA (rephrase tk).
</li>
</ol>
</section>
