...
<h2 id="my-desired-workflow"><a class="heading-self-link" href="#my-desired-workflow">My desired workflow</a></h2>
...
-   **Basic formatting:** Elements such as line spacing, margins, font should be set automatically.
-   **Citations:** In-text citations and bibliographies should be formatted automatically.
-   **Flexibility with styles:** I should be able to switch between, e.g., MLA, APA, and Chicago Manual Style without any fuss.
-   **Boilerplate text:** I want to do all of the above with very little to no boilerplate text in my org files (e.g. I shouldn't rely on many `#+LaTeX_header:` lines).
...
<h2 id="basic-formatting-org-latex-classes"><a class="heading-self-link" href="#basic-formatting-org-latex-classes">Basic Formatting: `org-latex-classes`</a></h2>

<h2 id="title-pages-creating-an-org-export-backend"><a class="heading-self-link" href="#title-pages-creating-an-org-export-backend">Title pages: Creating an Org-export backend</a></h2>
...
<h3 id="customize-the-org-export-latex-backend"><a class="heading-self-link" href="#customize-the-org-export-latex-backend">Customize the `org-export` LaTeX backend</a></h3>

File properties

<h4 id="backend"><a class="heading-self-link" href="#backend">Backend</a></h4>
...
<h4 id="template"><a class="heading-self-link" href="#template">Template</a></h4>

<h3 id="final-title-command"><a class="heading-self-link" href="#final-title-command">Final title command</a></h3>
...
<h2 id="citations-and-bibliographies-org-cite"><a class="heading-self-link" href="#citations-and-bibliographies-org-cite">Citations and bibliographies: Org-cite</a></h2>
...
<h3 id="one-way-to-specify-citation-style"><a class="heading-self-link" href="#one-way-to-specify-citation-style">One way to specify citation style</a></h3>
...
<h3 id="my-method-to-specify-citation-style"><a class="heading-self-link" href="#my-method-to-specify-citation-style">My method to specify citation style</a></h3>
...
<h2 id="final-result-and-screenshots"><a class="heading-self-link" href="#final-result-and-screenshots">Final result and screenshots</a></h2>

The following org file produces this:

which, compiled into a PDF, looks like this:

<h2 id="extras"><a class="heading-self-link" href="#extras">Extras</a></h2>

<div class="outline-text-2" id="text-extras">
</div>
<h3 id="section-numbers"><a class="heading-self-link" href="#section-numbers">Section numbers</a></h3>

```elisp
(setq org-export-with-section-numbers nil)
```

<h3 id="hyperref"><a class="heading-self-link" href="#hyperref">Hyperref</a></h3>
...
<h3 id="table-of-contents"><a class="heading-self-link" href="#table-of-contents">Table of contents</a></h3>
...
<h3 id="org-links"><a class="heading-self-link" href="#org-links">Org links</a></h3>

1.  Custom `org-mode` links (`org-link-set-parameters`)

<h2 id="full-configuration"><a class="heading-self-link" href="#full-configuration">Full configuration</a></h2>
