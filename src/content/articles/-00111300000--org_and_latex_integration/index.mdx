...
Nowadays, with the comparatively new `org-cite`, citations and bibliography is the easiest step of this process. Readers should refer to [Citations in org-mode: Org-cite and Citar](../posts/20221021T170551--citations-in-org-mode-org-cite-and-citar__guides.md) for more information, but once `org-cite` is set up, potentially with `citar`, org-export will seamlessly export citations and bibliographies.
