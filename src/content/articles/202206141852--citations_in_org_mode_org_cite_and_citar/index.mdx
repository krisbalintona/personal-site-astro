...
<h2 id="helpful-sources"><a href="#helpful-sources">Helpful sources</a></h2>
...
<h2 id="what-are-citation-systems"><a href="#what-are-citation-systems">What are citation systems?</a></h2>
...
<h2 id="org-cite"><a href="#org-cite">Org-cite</a></h2>
...
<h3 id="understanding-org-cite-export-processors"><a href="#understanding-org-cite-export-processors">Understanding `org-cite` export processors</a></h3>
...
<h3 id="which-processor-should-i-use"><a href="#which-processor-should-i-use">Which processor should I use?</a></h3>
...
*Otherwise*, use the `csl` processor<FootnoteRef name="2" /> (assuming you have a `.csl` file for your desired citation style).
...
2.  `#+PRINT_BIBLIOGRAPHY:` within a document to mark where the bibliography/references/works cited should be.<FootnoteRef name="6" />

<h2 id="citar"><a href="#citar">Citar</a></h2>
...
You can then set keybinds for common `citar` commands. For example, in the `:general` use-package keyword:<FootnoteRef name="7" />
...
<h3 id="capturing-outdated"><a href="#capturing-outdated">Capturing (Outdated)</a></h3>
...
If you use `org-roam`, then the following is how you select bibliographic source and create an `org-roam` node from it. All credit goes to [Jethro Kuan](https://www.jethro.dev/), the creator of `org-roam`, though I've made a few of my own customizations:<FootnoteRef name="8" />
...
I add it to an accessible keybinding:<FootnoteRef name="9" />
...
<h3 id="h:20241106T044538.716623"><a href="#h:20241106T044538.716623">Advising `citar-org-update-pre-suffix` (Outdated)</a></h3>
...
1.  Temporarily enable [typo-mode](https://github.com/jorgenschaefer/typoel).<FootnoteRef name="10" />
...
One can also add this command to `citar-citation-map`.<FootnoteRef name="11" />
...
<h2 id="other-interesting-packages"><a href="#other-interesting-packages">Other interesting packages</a></h2>

<div class="outline-text-2" id="text-other-interesting-packages">
</div>
<h3 id="zotero"><a href="#zotero">Zotero</a></h3>
...
<h3 id="embark"><a href="#embark">Embark</a></h3>
...
<h3 id="org-roam-bibtex"><a href="#org-roam-bibtex">Org-roam-bibtex</a></h3>
...
<h3 id="citar-capf"><a href="#citar-capf">Citar-capf</a></h3>

[Citar-capf](https://github.com/mclear-tools/citar-capf) provides a `complation-at-point-function`<FootnoteRef name="12" /> for citations. However, if you're reading this in the future, there's a likely chance that [this commit](https://github.com/emacs-citar/citar/commit/784791a090f9a2ed293f8b3ebd5636c690b718bc) would have been merged. The commit merges `citar-capf` with `citar`.

<h3 id="org-ref"><a href="#org-ref">Org-ref</a></h3>
...
<Footnote name="2" slot="footnotes">
See [Configuration](#configuration).
</Footnote>
<Footnote name="3" slot="footnotes">
...
<Footnote name="4" slot="footnotes">
...
<Footnote name="11" slot="footnotes">
See [Embark](#embark).
</Footnote>
<Footnote name="12" slot="footnotes">
