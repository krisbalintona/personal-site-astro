...
<dd>The first source you should visit should almost always be the manual (available within Emacs via `info`, i.e. `M-x info`). It covers the fundamentals to understanding how to use `org-cite`. Isn't well documented currently, but that will change in the future.</dd>
<dt>[Org-cite guide by tecosaur](https://blog.tecosaur.com/tmio/2021-07-31-citations.html)</dt>
<dd>I'll be referencing this frequently, for good reason.</dd>
</dl>
