...
<a id="what-are-citation-systems"></a>
...
<a id="understanding-org-cite-export-processors"></a>
...
<a id="which-processor-should-i-use"></a>
...
*Otherwise*, use the `csl` processor<sup><a id="fnref-2" class="fnref" href="#fn-2" role="doc-backlink" aria-label="Footnote 2">2</a></sup> (assuming you have a `.csl` file for your desired citation style).
...
As you can see, I have CSL be the default in every case aside from LaTeX. The styles can either be a file path or a file name in `org-cite-csl-styles-dir`​—see [Zotero](#zotero) for how to easily acquire CSL files.<sup><a id="fnref-4" class="fnref" href="#fn-4" role="doc-backlink" aria-label="Footnote 4">4</a></sup> (I use LaTeX strictly for my academic papers, so I really enjoy `biblatex`'s features.)

I also choose to customize faces—I prefer the green faces that `org-ref` uses:<sup><a id="fnref-5" class="fnref" href="#fn-5" role="doc-backlink" aria-label="Footnote 5">5</a></sup>
...
2.  `#+PRINT_BIBLIOGRAPHY:` within a document to mark where the bibliography/references/works cited should be.<sup><a id="fnref-6" class="fnref" href="#fn-6" role="doc-backlink" aria-label="Footnote 6">6</a></sup>
...
You can then set keybinds for common `citar` commands. For example, in the `:general` use-package keyword:<sup><a id="fnref-7" class="fnref" href="#fn-7" role="doc-backlink" aria-label="Footnote 7">7</a></sup>
...
If you use `org-roam`, then the following is how you select bibliographic source and create an `org-roam` node from it. All credit goes to [Jethro Kuan](https://www.jethro.dev/), the creator of `org-roam`, though I've made a few of my own customizations:<sup><a id="fnref-8" class="fnref" href="#fn-8" role="doc-backlink" aria-label="Footnote 8">8</a></sup>
...
I add it to an accessible keybinding:<sup><a id="fnref-9" class="fnref" href="#fn-9" role="doc-backlink" aria-label="Footnote 9">9</a></sup>
...
<a id="h:20241106T044538.716623"></a>
...
1.  Temporarily enable [typo-mode](https://github.com/jorgenschaefer/typoel).<sup><a id="fnref-10" class="fnref" href="#fn-10" role="doc-backlink" aria-label="Footnote 10">10</a></sup>
...
One can also add this command to `citar-citation-map`.<sup><a id="fnref-11" class="fnref" href="#fn-11" role="doc-backlink" aria-label="Footnote 11">11</a></sup>
...
<a id="other-interesting-packages"></a>
...
[Citar-capf](https://github.com/mclear-tools/citar-capf) provides a `complation-at-point-function`<sup><a id="fnref-12" class="fnref" href="#fn-12" role="doc-backlink" aria-label="Footnote 12">12</a></sup> for citations. However, if you're reading this in the future, there's a likely chance that [this commit](https://github.com/emacs-citar/citar/commit/784791a090f9a2ed293f8b3ebd5636c690b718bc) would have been merged. The commit merges `citar-capf` with `citar`.
...
<sup><a id="fn-1" href="#fnref-1">1</a></sup> The `basic` processor provides bare functionality and should never be preferred over the alternative, if possible.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-2" href="#fnref-2">2</a></sup> See [Configuration](#configuration).
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-3" href="#fnref-3">3</a></sup> This is an `org-export` backend. This means that, for instance, `md` refers to the `org-export` `md` backend as well as any other derived backends. Read the documentation for `org-export-define-derived-backend`.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-4" href="#fnref-4">4</a></sup> Notice that a citation style is required for the `csl` processor, and not for the `bibtex` processor.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-5" href="#fnref-5">5</a></sup> Be aware that I use `use-package`'s `:custom-face` keyword to redefine these two faces. One can just as easily use the built-in `defface` of `set-face-attribute`.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-6" href="#fnref-6">6</a></sup> Also see [this section of tecosaur's guide](https://blog.tecosaur.com/tmio/2021-07-31-citations.html#basic-usage).
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-7" href="#fnref-7">7</a></sup> You can also just use the built-in `define-key`.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-8" href="#fnref-8">8</a></sup> This assumes that you have `org-roam-bibtex` installed and enabled. See [Org-roam-bibtex](#org-roam-bibtex).
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-9" href="#fnref-9">9</a></sup> `kb/note-keys` is my own `general.el` leader key. I've mapped its prefix to `C-c n`.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-10" href="#fnref-10">10</a></sup> I prefer directly inserting curly quotes, em-dashes, and en-dashes into my buffers. I enable `typo-mode` here so that typing page ranges properly inserts en-dashes.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-11" href="#fnref-11">11</a></sup> See [Embark](#embark).
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-12" href="#fnref-12">12</a></sup> Also see <ContentLink collectionName="articles" id="202202211546--vertico_marginalia_all_the_icons_completion_and_orderless">Vertico, Marginalia, All-the-icons-completion, and Orderless</ContentLink>.
</li>
</ol>
</section>
