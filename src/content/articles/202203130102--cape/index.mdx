...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> See [Corfu, Kind-icon, and Corfu-doc](../posts/20221004T160712--corfu-kind-icon-and-corfu-doc__guides.md) to see the basic usage of `corfu` and several accessory packages.
