...
-   Each folder has an ID.<sup><a id="fnref-2" class="fnref" href="#fn-2" role="doc-backlink" aria-label="Footnote 2">2</a></sup>
...
For those who heavily customize Syncthing, there are other NixOS options available to tweak. You can find them [in the NixOS Search for options](https://search.nixos.org/options?channel=unstable&from=0&size=50&sort=relevance&type=packages&query=syncthing). Additionally, if you are trying to migrate an existing Syncthing configuration to Nix, then you can check out your config file at `~/.config/syncthing/config.xml`.<sup><a id="fnref-3" class="fnref" href="#fn-3" role="doc-backlink" aria-label="Footnote 3">3</a></sup> With this, you can see the value of every Syncthing setting (although the file will, of course, be in JSON format).
...
<sup><a id="fn-1" href="#fnref-1">1</a></sup> I use Emacs's org-agenda to manage todos, and I've set up [Orgzly Revived](https://github.com/orgzly-revived/orgzly-android-revived) for basic creation and editing of org todos on my phone.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-2" href="#fnref-2">2</a></sup> You can see the ID of shared folders in the Syncthing GUI by expanding the collapsed info section a folder under the folders section of the GUI's homepage.
</li>
<li class="fn" role="doc-footnote">
<sup><a id="fn-3" href="#fnref-3">3</a></sup> Users can refer to the [Syncthing configuration file documentation](https://docs.syncthing.net/users/config.html) in order to understand the contents of this file.
</li>
</ol>
</section>
