...
<li>
<a href="#the-dilemma">The dilemma</a>
</li>
<li>
...
<Heading level="2" id="the-dilemma"selfLink={true}>The dilemma</Heading>
...
<Heading level="2" id="final-result"selfLink={true}>Final result</Heading>
...
<Heading level="2" id="final-words"selfLink={true}>Final words</Heading>
