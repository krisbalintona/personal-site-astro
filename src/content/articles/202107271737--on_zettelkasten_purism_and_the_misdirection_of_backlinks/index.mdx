...
<Heading level="2" id="i-disagree-with-backlink-exceptionalism"selfLink={true}>I disagree with ‘backlink exceptionalism’</Heading>
...
<Heading level="2" id="the-practice-is-most-essential"selfLink={true}>The ‘practice’ is most essential</Heading>
...
<Heading level="3" id="an-aside-but-what-about-backlinks"selfLink={true}>An aside: but what about backlinks?!</Heading>
...
<Heading level="2" id="luhmann-isnt-the-only-success-story"selfLink={true}>Luhmann isn't the only success story</Heading>
...
<Heading level="2" id="so-what-do-you-do-now"selfLink={true}>So what do you do now?</Heading>
...
<Heading level="2" id="how-has-my-own-advice-affected-me"selfLink={true}>How has my own advice affected me?</Heading>
