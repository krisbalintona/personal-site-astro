...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> I sometimes use `occur-edit-mode` (bound to `e` in `occur-mode` buffers), and the added context lines can be relevant to the edits I want to make to the matched text.
