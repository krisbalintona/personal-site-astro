...
<Alert><span class="timestamp-wrapper"><span class="timestamp">[2023-07-20 Thu]</span></span> Readers should be aware that some package-specific information in this article may be outdated. Thus, readers are advised from outright copying code in this article without verifying (e.g. reading docstrings) the intended behavior. Nevertheless, the concepts related to `org-cite` and citation management should remain relevant and insightful.</Alert>
