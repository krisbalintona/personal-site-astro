---
title: "Keeping a tidy .emacs.d/ with no-littering.el"
date: 2025-04-20T19:34:00-05:00
---
...
1.  [1.2](#12):ignore:
    1.  [Body](#body):ignore:
    2.  [Bonus: `(no-littering-theme-backups)`](#bonus-no-littering-theme-backups)
...
[No-littering.el](https://github.com/emacscollective/no-littering) keeps your .emacs.d clean. I've been using it for years&mdash;in fact it's one of the only third-party packages I first installed several years ago when I started using Emacs that I still have in my config today.
...
<div><pre>{`no-littering-theme-backups is an autoloaded native-comp-function in
no-littering.el.
