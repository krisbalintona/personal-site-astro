...
1.  [My desired workflow](#my-desired-workflow)
2.  [Basic Formatting: `org-latex-classes`](#basic-formatting-org-latex-classes)
3.  [Title pages: Creating an Org-export backend](#title-pages-creating-an-org-export-backend)
    1.  [Customize the `org-export` LaTeX backend](#customize-the-org-export-latex-backend)
        1.  [Backend](#backend)
        2.  [Template](#template)
    2.  [Final title command](#final-title-command)
4.  [Citations and bibliographies: Org-cite](#citations-and-bibliographies-org-cite)
    1.  [One way to specify citation style](#one-way-to-specify-citation-style)
    2.  [My method to specify citation style](#my-method-to-specify-citation-style)
5.  [Final result and screenshots](#final-result-and-screenshots)
6.  [Extras](#extras)
    1.  [Section numbers](#section-numbers)
    2.  [Hyperref](#hyperref)
    3.  [Table of contents](#table-of-contents)
    4.  [Org links](#org-links)
7.  [Full configuration](#full-configuration)



<a id="my-desired-workflow"></a>
...
<a id="basic-formatting-org-latex-classes"></a>

# Basic Formatting: `org-latex-classes`


<a id="title-pages-creating-an-org-export-backend"></a>

# Title pages: Creating an Org-export backend

The most challenging hurdle is conveniently producing a formatted title page<sup><a id="fnr.1" class="footref" href="#fn.1" role="doc-backlink">1</a></sup>.
...
<a id="customize-the-org-export-latex-backend"></a>

## Customize the `org-export` LaTeX backend
...
<a id="citations-and-bibliographies-org-cite"></a>

# Citations and bibliographies: Org-cite

Nowadays, with the comparatively new `org-cite`, citations and bibliography is the easiest step of this process. Readers should refer to [Citations in org-mode: Org-cite and Citar](20221021T170551--citations-in-org-mode-org-cite-and-citar__guides.md) for more information, but once `org-cite` is set up, potentially with `citar`, org-export will seamlessly export citations and bibliographies.
...
<a id="one-way-to-specify-citation-style"></a>

## One way to specify citation style
...
;; "cite<sub>export</sub>" keyword.  If you need to use different styles for bibliography<br />
;; and citations, you can separate them with "bibstyle/citestyle" syntax.  E.g.,<br />
;;<br />
;;   #+cite<sub>export</sub>: biblatex authortitle/authortitle-ibid<br />
</p>
...
<a id="my-method-to-specify-citation-style"></a>

## My method to specify citation style
...
<a id="final-result-and-screenshots"></a>

# Final result and screenshots
...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> I use the term “title page” to reference what a stylesheet specifies as the format of a title, even if it does not create an entirely new page, e.g., MLA (rephrase tk).
