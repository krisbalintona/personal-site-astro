---
title: "Cape"
date: 2022-03-13T01:02:00-06:00
---

# Table of Contents

1.  [What is `cape`?](#what-is-cape)
2.  [Basic usage: keybinds](#basic-usage-keybinds)
3.  [Adding backends to `completion-at-point-functions`](#adding-backends-to-completion-at-point-functions)
4.  [`Cape-company-to-capf` and `cape-super-capf`](#cape-company-to-capf-and-cape-super-capf)
5.  [`pcomplete` nicety](#pcomplete-nicety)
6.  [My `completion-at-point-functions`](#my-completion-at-point-functions)
